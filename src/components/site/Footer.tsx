      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-14 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2">
              <MapPin className="w-4 h-4 mt-0.5 shrink-0" aria-hidden="true" focusable="false" />
              <a
                href={MAPS_URL}
                target="_blank"
            ...
            <li className="flex items-center gap-2">
              <PhoneIcon className="w-4 h-4" aria-hidden="true" focusable="false" />
        ...
        <div>
          ...
          <div className="flex gap-3">
            ...
            >
              <Facebook className="w-4 h-4" aria-hidden="true" focusable="false" />
            </a>
            <a
              ...
              className="w-9 h-9 rounded border border-gold/30 hover:border-gold hover:bg-gold/10 flex items-center justify-center transition"
            >
              <Instagram className="w-4 h-4" aria-hidden="true" focusable="false" />
            </a>
            <a
              href={SOCIALS.tiktok}
              target="_blank"
            ...
            >
              <svg
                ...
                focusable="false"
              >
                <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5.8 20.1a6.34 6.34 0 0 0 10.86-4.43V9.65a8.16 8.16 0 0 0 4.77 1.52V7.72a4.85 4.85 0 0 1-1.84-1.03Z" />
              </svg>
            </a>
            <a
              ...
              className="w-9 h-9 rounded border border-gold/30 hover:border-gold hover:bg-gold/10 flex items-center justify-center transition"
            >
              <Youtube className="w-4 h-4" aria-hidden="true" focusable="false" />
            </a>
          </div>
          <div className="mt-6">
