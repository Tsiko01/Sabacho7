  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "Sabacho tasting menu, Georgian wine tasting, qvevri wine Kakheti, chacha tasting, Georgian cognac, Kakheti wine cellar tasting",
      },
    ...
    <div className="bg-background text-foreground min-h-screen">
        ...
        <div className="max-w-6xl mx-auto space-y-14">
          {Object.entries(grouped).map(([cat, list]) => (
            <section key={cat} aria-label={cat}>
              <h2 className="font-serif text-3xl text-gold mb-6 pb-3 border-b border-gold/20">
                {cat}
              </h2>
                  ...
                  >
                    ...
                    <div className="p-5">
                      <h3 className="font-serif text-2xl">
                        {pickLang(it, "name", lang) || it.name}
                      </h3>
                      <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                        {pickLang(it, "description", lang) || it.description}
                      </p>
                      {it.taste_notes && (
          ...
          {items.length === 0 && (
            <p className="text-center text-muted-foreground">Tasting menu coming soon.</p>
          )}
        </div>
      </main>
      <Footer />
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Tasting Menu", item: "/tasting", position: 2 },
        ]}
      />
      <Schema
        schema={buildWebPageSchema(
          "Tasting Menu | SABACHO Marani",
          "Wines, Chacha, aged Cognac and traditional Georgian pairings from Sabacho's private cellar.",
          "/tasting",
        )}
      />
