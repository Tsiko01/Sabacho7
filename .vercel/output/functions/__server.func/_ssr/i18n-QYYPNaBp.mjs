...
var dicts = {
	...
	ka: {
		...
		"book.exp.wine": "ღვინის დეგუსტაცია ($20 / პიროვნება)",
		"book.exp.supra": "ქართული სუფრა ($50 / პიროვნება)",
	...
	uk: {
		...
		"book.exp.wine": "Дегустація вина ($25 / особа)",
		"book.exp.supra": "Грузинське Супра ($50 / особа)",
...
function I18nProvider({ children }) {
	...
	(0, import_react.useEffect)(() => {
		try {
			const saved = localStorage.getItem("sabacho-lang");
...
function pickLang(row, base, lang) {
	const v = row[lang === "en" ? base : `${base}_${lang}`];
	if (typeof v === "string" && v.trim()) return v;
	const fallback = row[base];
	return typeof fallback === "string" ? fallback : "";
}
//#endregion
export { useI18n as i, LANGS as n, pickLang as r, I18nProvider as t };
